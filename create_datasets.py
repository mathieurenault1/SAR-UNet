...
if __name__ == "__main__":
    create_dataset(input_length=6, image_ahead=18, rain_amount_thresh=0.5)
    create_dataset(input_length=6, image_ahead=24, rain_amount_thresh=0.5)
    create_dataset(input_length=6, image_ahead=36, rain_amount_thresh=0.5)
    create_dataset(input_length=18, image_ahead=12, rain_amount_thresh=0.5)
    create_dataset(input_length=18, image_ahead=18, rain_amount_thresh=0.5)
    create_dataset(input_length=18, image_ahead=24, rain_amount_thresh=0.5)
    create_dataset(input_length=18, image_ahead=36, rain_amount_thresh=0.5)